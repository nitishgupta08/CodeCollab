...
function SpaceSidebar({
  ...
  const deleteFile = (id) => {
    ...
    if (sideTabIndex !== -1)
      dispatch({
        type: "updateSideTab",
        payload: sideTabIndex === 0 ? sideTabIndex : sideTabIndex - 1,
      });
            ...
            >
              ...
              <FormControl sx={{ width: 150 }} size="small">
                ...
                <Select
                  ...
                  onChange={(e) =>
                    setFile({ ...file, langIndex: e.target.value })
                  }
                  label="Language"
                  input={<CustomInput />}
                >
                  {editorLang.map((lang, id) => {
                    return (
                      <MenuItem value={lang.index} key={id}>
                        {lang.name}
                      </MenuItem>
                    );
                  })}
        ...
        <Box sx={{ flexGrow: 1, display: "flex", height: "80vh", mt: 2 }}>
          <DataStyledTabs
            ...
            onChange={(event, newValue) =>
              dispatch({ type: "updateSideTab", payload: newValue })
            }
            variant="scrollable"
